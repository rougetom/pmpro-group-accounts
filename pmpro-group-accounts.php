...
define( 'PMPROGROUPACCT_VERSION', '1.7.5' );
...
include_once( PMPROGROUPACCT_DIR . '/includes/checkout-steps.php' );
include_once( PMPROGROUPACCT_DIR . '/includes/checkout-ux.php' );
